  ...
  return (
    ...
    >
      ...
      {/* 
        ...
        overflow-y-auto enables scrolling for tall content (mobile).
      */}
      ...
      ">
        ...
        */}
        <div className="w-full max-w-[1800px] grid grid-cols-1 lg:grid-cols-[0.6fr_3.4fr] gap-[clamp(1rem,2vw,2rem)] items-center">
          
          {/* --- Left: Image (Hidden on Mobile) --- */}
          <div className="hidden lg:flex justify-start items-center relative z-10 -ml-[clamp(2rem,4vw,4rem)]">
            <div className="relative 
              w-[clamp(280px,30vw,450px)] h-[600px] /* Height approximates card grid height */
            ">
              <Image 
                src="/slide4.webp" 
          ...
          {/* --- Right: Puzzle Cards --- */}
          <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[1.5rem] lg:gap-0 px-[0.5rem]">
            ...
            <PuzzleCard 
              ...
              shapeClass="lg:rounded-r-2xl lg:rounded-l-none lg:clip-[polygon(15%_0%,100%_0%,100%_100%,15%_100%,10%_75%,0%_65%,10%_50%,0%_35%,10%_25%,0%_15%)]"
            />
...
const PuzzleCard = ({ index, icon, title, description, stat, statLabel, shapeClass }: PuzzleCardProps) => {
  return (
    ...
    >
      ...
      <div className="mt-6">
        <div className="
          text-[clamp(1.8rem,2.2vw,2.2rem)] font-bold 
