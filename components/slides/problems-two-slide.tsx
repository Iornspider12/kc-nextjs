      ...
      */}
      ...
      >
        ...
        <div className="w-full h-full flex flex-col items-center justify-center px-[60px]">
          ...
          */}
          <div className="w-full max-w-[1800px] grid grid-cols-1 lg:grid-cols-[3fr_1fr] gap-[30px] items-center">

            {/* --- Left: Puzzle Cards --- */}
            <div className="order-2 lg:order-1 w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[20px] lg:gap-0 px-[10px] lg:pr-[30px]">
              ...
              <PuzzleCard
                ...
                shapeClass="md:col-span-2 lg:col-span-1 lg:rounded-r-2xl lg:rounded-l-none lg:[clip-path:polygon(15%_0%,100%_0%,100%_100%,15%_100%,10%_75%,0%_65%,10%_50%,0%_35%,10%_25%,0%_15%)]"
              />

            </div>

            {/* --- Right: Image (Top on Mobile) --- */}
            <div className="order-1 lg:order-2 flex justify-center items-center relative z-10 lg:-ml-[20px]">
